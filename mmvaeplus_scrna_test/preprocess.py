...
def construct_graph_by_feature(adata_omics1, adata_omics2, n_neighbors=20, mode="connectivity",
                               metric="correlation"):
...
def adjacent_matrix_preprocessing(adata_omics1, adata_omics2, n_neighbors=20):
    ...
    edge_index_feature_omics1, edge_index_feature_omics2 = construct_graph_by_feature(adata_omics1, adata_omics2, n_neighbors=n_neighbors)
