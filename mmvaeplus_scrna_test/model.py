...
class mmvaeplus(Module):
    ...
    def __init__(self, omics1_dim, omics2_dim, zs_dim, zp_dim, hidden_dim_omics1=256, hidden_dim_omics2=256, device=torch.device('cpu'), recon_type_omics1='zinb', recon_type_omics2='nb', heads=1,
                 omics1_batch_dim=1):
        ...
        self.decoder_omics1 = Decoder(self.latent_dim, hidden_dim_omics1, omics1_dim, recon_type=recon_type_omics1)
    ...
    def loss(self, x_omics1, x_omics2, edge_index_omics1, edge_index_omics2, label):
        ...
        if self.recon_type_omics1 == 'nb':
            ...
            raise NotImplementedError
        label_logits = self.decon_model(torch.cat([zs_mu_omics1, zp_mu_omics1], dim=1))
        clas = F.cross_entropy(label_logits, label)
        ...
        return {"recon_omics1": recon_omics1, "recon_omics2_cross": recon_omics2_cross, "kl_zs_omics1": kl_zs_omics1,
                ...
                "kl_zs_omics2": kl_zs_omics2, "kl_zp_omics2": kl_zp_omics2, "clas": clas}
