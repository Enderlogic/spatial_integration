...
def _load_brainlarge_file(
    ...
    with h5py.File(path_to_file, "r") as f:
        ...
        var = gene_var_sample_matrix.multiply(gene_var_sample_matrix).mean(axis=1) - np.multiply(
            mean, mean
        )
        ...
        for i in range(n_iters):
            ...
            index_partitioner_batch = (index_partitioner_batch - first_index_batch).astype(
                np.int32
            )
