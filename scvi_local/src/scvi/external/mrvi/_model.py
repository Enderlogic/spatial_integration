...
from ...data import AnnDataManager, fields
from ...external.mrvi._module import MRVAE
from ...external.mrvi._types import MRVIReduction
from ...external.mrvi._utils import rowwise_max_excluding_diagonal
from ...model.base import BaseModelClass, JaxTrainingMixin
from ...utils import setup_anndata_dsp
from ...utils._docstrings import devices_dsp
...
class MRVI(JaxTrainingMixin, BaseModelClass):
    ...
    def compute_local_statistics(
        ...
        from ...external.mrvi._utils import _parse_local_statistics_requirements
