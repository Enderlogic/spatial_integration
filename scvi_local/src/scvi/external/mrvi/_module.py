...
from ...external.mrvi._components import AttentionBlock, Dense
from ...module.base import JaxBaseModuleClass, LossOutput, flax_configure
...
class EncoderXU(nn.Module):
    ...
    def __call__(
        ...
        from ...external.mrvi._components import ConditionalNormalization, NormalDistOutputNN
