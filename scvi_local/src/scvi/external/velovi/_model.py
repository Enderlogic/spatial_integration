...
from ...external.velovi._constants import VELOVI_REGISTRY_KEYS
from ...external.velovi._module import VELOVAE
from ...model.base import BaseModelClass, UnsupervisedTrainingMixin, VAEMixin
from ...train import TrainingPlan, TrainRunner
from ...utils._docstrings import devices_dsp, setup_anndata_dsp
...
class VELOVI(VAEMixin, UnsupervisedTrainingMixin, BaseModelClass):
    ...
    **model_kwargs
    ...
    def _shuffle_layer_celltype(
        ...
        from ...data._constants import _SCVI_UUID_KEY
