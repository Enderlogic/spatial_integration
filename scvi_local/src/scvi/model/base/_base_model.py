...
from ...data._utils import _assign_adata_uuid, _check_if_view, _get_adata_minify_type
from ...dataloaders import AnnDataLoader
from ...model._utils import parse_device_args
from ...model.base._constants import SAVE_KEYS
from ...model.base._save_load import (
    _initialize_model,
...
class BaseModelClass(metaclass=BaseModelMetaClass):
    ...
    def save(
        ...
        **anndata_write_kwargs,
        ...
        """
        from ...model.base._save_load import _get_var_names
