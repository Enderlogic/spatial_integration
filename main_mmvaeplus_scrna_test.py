...
heads = 1
result_path = 'results/test_scrna.csv'
result = pd.DataFrame(
    columns=['dataset', 'learning_rate', 'zs_dim', 'zp_dim', 'hidden_dim1', 'hidden_dim2', 'heads', 'weight_omics1',
             'weight_omics2', 'weight_kl', 'weight_clas', 'epoch', 'n_cluster', 'ari', 'mi', 'nmi', 'ami', 'hom', 'vme',
             'ave_score'])
...
for dataname in dataset:
    ...
    model = MMVAEPLUS(adata_omics1, adata_omics2, adata_sc_omics1, n_neighbors=n_neighbors, learning_rate=learning_rate,
                      epochs=600, zs_dim=zs_dim, zp_dim=zp_dim, hidden_dim1=hidden_dim1, hidden_dim2=hidden_dim2,
                      weight_omics1=weight_omics1, weight_omics2=weight_omics2, weight_kl=weight_kl,
