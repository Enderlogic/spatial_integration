...
for dataname in dataset:
    ...
    model = MMVAEPLUS(adata_omics1, adata_omics2, n_neighbors=20, learning_rate=1e-4, epochs=epochs, zs_dim=16,
                      zp_dim=16, hidden_dim1=512, hidden_dim2=256, weight_omics1=1, weight_omics2=1, weight_kl=10,
                      heads=3, recon_type='nb')
    # train model
